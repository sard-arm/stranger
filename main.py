...
bullet_img = pygame.transform.scale(pygame.image.load("images/bullet_h.png"), (16, 16))

bullet = Object(bullet_img, -32, -32, 5)
flag_bullet = -1
#creat Group object
...
#creat coins
coin1 = Object(coin1_img, 8, 352, 0)
coin2 = Object(coin1_img, 8, 362, 0)
coin3 = Object(coin1_img, 200, 36, 0)
coin4 = Object(coin1_img, 200, 72, 0)
coin5 = Object(coin1_img, 700, 500, 0)
coin6 = Object(coin1_img, 600, 500, 0)
coin7 = Object(coin1_img, 8, 700, 400)
coin8 = Object(coin1_img, 8, 600, 400)
coin9 = Object(coin1_img, 88, 302, 0)
coin10 = Object(coin1_img, 90, 462, 0)
#add to sprites
coins.add(coin1)
...
enemy3 = Object(enemy_img, 752, 36, 3)
enemy4 = Object(enemy_img, 752, 72, 3)
enemy5 = Object(enemy_img, 450, 36, 3)
enemy6 = Object(enemy_img, 450, 36, 3)
...
wall5 = Object(wall_h, 0, 48, 0)
wall6 = Object(pygame.transform.scale(wall_v, (8, 532)),  164, 8, 0)
...
run_game = True
danger_flag = False
mb.showinfo("Stranger", "Собирите все монетки, избегая врагов, кажется просто, но у вас всего 3 жизни, так что постарайтесь!")
while run_game:
    if lives != 0:
        window.blit(bg, (0, 0))
        ...
        if flag:
            if event.type == pygame.KEYDOWN:
                ...
                if keys[pygame.K_SPACE]:
                    all_sprites.remove(bullet)
                    bullets.remove(bullet)
                    bullet = Object(bullet_img, player.rect.x, player.rect.y, 5)
                    bullets.add(bullet)
        ...
        bullet.rect.x += bullet.speed * flag_bullet
        ...
        if len(pygame.sprite.spritecollide(player, enemies, False)) > 0:
            ...
            player.rect.y = start_y
            lives -= 1
        if len(pygame.sprite.spritecollide(bullet, walls, False)) > 0:
            all_sprites.remove(bullet)
            bullets.remove(bullet)
        if len(pygame.sprite.spritecollide(bullet, enemies, True)) > 0:
            print("hit")
    ...
    if count == 8 and not(winner_flag):
